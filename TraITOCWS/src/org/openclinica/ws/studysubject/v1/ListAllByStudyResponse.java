 ...
 *         &lt;element name="studySubjects" type="{http://openclinica.org/ws/beans}studySubjectsType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "listAllByStudyResponse")
@SuppressWarnings("javadoc")
public class ListAllByStudyResponse {
    ...
    @XmlElement(required = true)
    protected StudySubjectsType studySubjects;
     ...
     * @return
     *     possible object is
     *     {@link StudySubjectsType }
     *     
     */
    public StudySubjectsType getStudySubjects() {
     ...
     *     
     */
    public void setStudySubjects(StudySubjectsType value) {
