    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.openclinica.ws.study.v1.WsService.class.getName());
    ...
    public WsService() {
        super(WSSERVICE_WSDL_LOCATION, new QName("http://openclinica.org/ws/study/v1", "wsService"));
    }
    ...
    public Ws getWsSoap11() {
        return super.getPort(new QName("http://openclinica.org/ws/study/v1", "wsSoap11"), Ws.class);
    }
    ...
    public Ws getWsSoap11(WebServiceFeature... features) {
        return super.getPort(new QName("http://openclinica.org/ws/study/v1", "wsSoap11"), Ws.class, features);
    }
